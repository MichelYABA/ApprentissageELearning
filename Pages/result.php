                ...
                <div class="col-lg-4">
                     <a href="../index.php">
                        <!--img src="http://via.placeholder.com/350x150"-->
                            <img src="../images/desert.jpg" class="logo">
                    </a>
                </div>
            ...
            <div class="row">
                <div class="col-lg-10 offset-1">
                    ...
                    <table class="table">
                        ...
                        <tbody>
                            <tr>
                                <th scope="row">Giacomo</th>
                                <td>37</td>
                                <td>Peldi</td>
                                <td>
                                    <div class="form-check">
                                        <label class="form-check-label">
                                            <input class="form-check-input position-static" type="radio" name="Radio" checked value="#">
                                        </label>
                                    </div>
                                </td>
                            </tr>
                            <tr>
                                <th scope="row">Marco Botton</th>
                                <td>34</td>
                                <td></td>
                                <td>
                                    <div class="form-check">
