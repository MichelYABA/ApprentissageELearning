                ...
                <div class="col-lg-8">
                    ...
                    <form action="treatment.php" method="POST" id="formulaire">
                        <div class="form-group" id="algo" >
                            ...
                            <div class="form-check form-check-inline">
                                <label class="form-check-label">
                                    <input id="k-means" class="form-check-input" type="radio" name="typeAlgorithme" value="k-means">K-Means
                                </label>
                                <div class="form-group">
                                    <select class="form-control" id="option">
                                        <option>Option</option>
                        ...
                        <fieldset>
                           <legend>Document (TXT, EXCEL)</legend>
                            <div class="form-group text-center">
                               
                                <div class="form-group" id="up_fich">
									<br/>
                                    <label for="">Déposer votre fichier ici</label>
									<br/><br/>
                        ...
                        <br>
                        <div class="form-group">
                            <button type="submit" id="submit" name="submit" class="btn btn-primary float-right">Envoyer en traitement</button>
                        </div>
                    </form>
                    ...
                    <div class="dropdown">
                        ...
                        <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                            ...
                            <a class="dropdown-item" href="intermediaryUser.php">Profil Intermédiaire</a>
                        </div>
                    </div>
                </div>
            </div>
